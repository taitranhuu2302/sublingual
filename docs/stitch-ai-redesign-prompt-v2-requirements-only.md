...
6. **Professional but warm** — Not corporate-sterile. Emerald/green accent preferred (signals "live" and "active"). Soft depth (subtle shadows, translucent surfaces). Think modern developer tools, not enterprise software.
...
A complete visual redesign proposal including:

1. **All screens** at high fidelity for both dark and light themes
...
5. **Design tokens** — color palette, spacing scale, typography, shadows, radii
