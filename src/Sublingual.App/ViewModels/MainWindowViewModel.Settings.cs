...
public sealed partial class MainWindowViewModel
{
    ...
    private void OnPropertyChanged(object? sender, PropertyChangedEventArgs e)
    {
        ...
        if (e.PropertyName == nameof(SpeechModelDownloadStatus))
        {
            OnPropertyChanged(new PropertyChangedEventArgs(nameof(HasSpeechModelDownloadStatus)));
        }

        if (e.PropertyName == nameof(SpeechModelDownloadErrorMessage))
        {
            OnPropertyChanged(new PropertyChangedEventArgs(nameof(HasSpeechModelDownloadError)));
        }
        ...
        if (e.PropertyName is nameof(TranslationPrimaryProvider)
            ...
            or nameof(SpeakingPracticeAiProvider)
            or nameof(SpeakingPracticeGroqApiKey)
            or nameof(SpeakingPracticeGroqModel)
            or nameof(SpeakingPracticeGeminiApiKey)
            or nameof(SpeakingPracticeGeminiModel)
