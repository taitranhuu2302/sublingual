...
public sealed class WasapiMicrophoneCaptureService : IAudioCaptureService, IDisposable
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (sourceType != AudioSourceType.Microphone || !OperatingSystem.IsWindows())
        {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new PlatformNotSupportedException("WASAPI microphone capture is only supported on Windows.");
        }

        if (request.SourceType != AudioSourceType.Microphone)
        {
            throw new NotSupportedException("WasapiMicrophoneCaptureService only supports microphone capture.");
        }
